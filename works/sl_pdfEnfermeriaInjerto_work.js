...
define(['N/record','N/log','N/render','N/xml', 'N/file'],
    ...
    function(record,log,render,xmlMod,file) {
        ...
        function onRequest(context)
        {
            ...
            xml += '<br/><br/><br/><br/><br/>';
            xml += '<p style="width:35%;background-color:#346094;color:#FFFFFF;font-family:Aria, sans-serif;align:center">HOJA DE ENFERMERÍA KHG</p>';
            ...
            xml += '<p style="width:35%;background-color:#346094;color:#FFFFFF;font-family:Aria, sans-serif;align:center">HOJA DE CONTROL KHG</p>';
            ...
            xml += '</tr>';
            xml += '<tr>';
            xml += '<td align="center" width="50%"><img src="'+diseno_Img1_url+'" width="200" height="200" /></td>';
            xml += '<td align="center" width="50%"><img src="'+diseno_Img2_url+'" width="200" height="200" /></td>';
            xml += '</tr>';
            xml += '<tr>';
            xml += '<td align="center" width="50%"><img src="'+diseno_Img3_url+'" width="200" height="200" /></td>';
            xml += '<td align="center" width="50%"><img src="'+diseno_Img4_url+'" width="200" height="200" /></td>';
            xml += '</tr>';
            xml += '<tr>';
            ...
            xml += '<table style="width:100%;font-size:12px;font-family:Aria,sans-serif;">';
            xml += '<tr>';
            xml += '<td align="center"><b>FOTOS ANTES DEL INJERTO</b><img src="'+diseno_Img1_urlIMG+'" width="200" height="190" /></td>';
            xml += '<td align="center"><b>FOTOS DESPÚES DEL INJERTO</b><img src="'+diseno_Img2_urlIMG+'" width="200" height="190" /></td>';
            xml += '</tr>';
            xml += '<tr>';
            xml += '<td align="center"><b>FOTOS ANTES DE FRENTE</b><img src="'+diseno_Img3_urlIMG+'" width="200" height="190" /></td>';
            xml += '<td align="center"><b>FOTOS ANTES DE FRENTE 2</b><img src="'+diseno_Img4_urlIMG+'" width="200" height="190" /></td>';
            xml += '</tr>';
            xml += '<tr>';
            ...
            xml += '<p style="width:45%;background-color:#346094;color:#FFFFFF;font-family:Aria, sans-serif;align:center">NOTA POST PROCEDIMIENTO</p>';
            ...
            xml += '</tr>';
            xml += '</table>';
            xml += '<p></p><p style="font-family:Aria, sans-serif; font-size:12px;">Inicia protocolo de microinjerto capilar con técnica KHR. \n' +
            ...
            xml += '<p style="width:45%;background-color:#346094;color:#FFFFFF;font-family:Aria, sans-serif;align:center">CONSENTIMIENTO INFORMADO</p>';
            ...
            xml += '<p style="width:35%;background-color:#346094;color:#FFFFFF;font-family:Aria, sans-serif;align:center"><b>REVISIONES EFECTUADAS</b></p>';
