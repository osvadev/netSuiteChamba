...
define(['N/record', 'N/log', 'N/render', 'N/xml', 'N/runtime'],
    ...
    function (record, log, render, xmlMod, runtime) {
        ...
        function onRequest(context) {
            ...
            var edoCivil = cliente.getText({ fieldId: 'custentity242'});
            ...
            var resRenal = caso.getValue({ fieldId: 'custevent233' }); //Tratamiento problema renal
            ...
            var respuesta = caso.getValue({ fieldId: 'custevent237' }); //Resultado VIH
            ...
            //var tomaMedicamento = checado(caso.getValue({ fieldId: 'custevent239' })); //Toma actualmente medicamento
            var queTipoDeCicatrizacion = caso.getText({ fieldId: 'custevent229' }); //Que tipo de cicatrizacion tiene
            //var cualMedicamento = caso.getValue({ fieldId: 'custevent240' }); //Cual medicamento
            ...
            var resHepatitis = caso.getValue({ fieldId: 'custevent532' }); //Resultado hepatitis
            ...
            var resHipertension = caso.getValue({ fieldId: 'custevent253' }); //Respuesta hipertension
            ...
            //var sangradoGinNasal = checado(caso.getValue({ fieldId: 'custevent228' })); // sangrado Gin o Nasal
            //var otros = caso.getValue({ fieldId: 'custevent488'}); // Hitorial clinico personal OTRAS enfermedades
            ...
            var diabetes1 = checado(caso.getText({ fieldId: 'custevent255' })); //caso.getText({ fieldId: 'custevent255' });
            var especifiqueDiabetes1 = caso.getText({ fieldId: 'custevent257' });
            var hipertensionArterial = checado(caso.getText({ fieldId: 'custevent256' })); //(caso.getText({ fieldId: 'custevent256' }));
            var especifiqueHipertensionArterial = caso.getText({ fieldId: 'custevent259' });
            var cancer2 = checado(caso.getText({ fieldId: 'custevent258' })); //caso.getText({ fieldId: 'custevent258' });
            ...
            var idc = caso.getText({ fieldId: 'custevent541'}); //Indice de masa corporal paciente

            // Sección DATOS CLINICOS REELEVANTES
            ...
            xml += '<tr><td><b>DIRECCIÓN: </b> ' + address + '</td><td><b>ESTADO CIVIL: </b>' + edoCivil + '</td></tr>';
            xml += '</table>';
            xml += '<br/>';
            ...
            xml += '<tr><td align="left" colspan="4" color="#FFFFFF" background-color="#346094"><b> Antecedentes Personales</b></td></tr>';
/*             xml += '<tr><td align="left" widht="35%">Enfermedad de importancia en abuelos</td><td align="left" width="10%">' + enfermedadDeImportancia + '</td>';
            xml += '<td align="left" width="10%">¿Cuál?: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + cual5 + '</b></td></tr>';*/
            xml += '<tr><td align="left" widht="35%">Enfermedades de importancia</td><td align="left" width="10%">' + enfermedadDeImportancia + '</td>';
            xml += '<td align="left" width="10%">¿Cuál?: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resEnfermedadDeImportancia + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Cirugías previas</td><td align="left" width="10%">' + algunaCirugiaPrevia + '</td>';
            xml += '<td align="left" width="10%">¿Cuál?: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + cual2 + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">¿Le han aplicado anestecia?</td><td align="left" width="10%" colspan="3"><b>' + anestesiaPrevia + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Alergias</td><td align="left" width="10%">' + sufreDeAlgunTipo + '</td>';
            xml += '<td align="left" width="10%">¿Cuál?: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + cual3 + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Diabetes</td><td align="left" width="10%"><b>' + sufreUstedDiabetes + '</b></td>';
            xml += '<td align="left" width="10%">Tratamiento: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + tratamiento + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Hipertensión arterial</td><td align="left" width="10%">' + hipertension + '</td>';
            xml += '<td align="left" width="10%">Tratamiento: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resHipertension + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Problemas Cardíacos</td><td align="left" width="10%">' + cardiacos + '</td>';
            xml += '<td align="left" width="10%">Especifique: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resCardiacos + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Enfermedades respiratorias</td><td align="left" width="10%">' + respiratorios + '</td>';
            xml += '<td align="left" width="10%">Especifique: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resRespiratorios + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Enfermedades renales</td><td align="left" width="10%">' + renal + '</td>';
            xml += '<td align="left" width="10%">Tratamiento: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resRenal + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Problemas Hepáticos</td><td align="left" width="10%">' + hepaticos + '</td>';
            xml += '<td align="left" width="10%">Especifique: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resHepaticos + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Problemas Gastrointestinales</td><td align="left" width="10%">' + gastrointestinales + '</td>';
            xml += '<td align="left" width="10%">Especifique: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resGastrointestinales + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Afecciones en la piel</td><td align="left" width="10%">' + afeccionesPiel + '</td>';
            xml += '<td align="left" width="10%">Especifique: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resAfeccionesPiel + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Antecedentes de cáncer</td><td align="left" width="10%">' + cancer + '</td>';
            xml += '<td align="left" width="10%">Especifique: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resCancer + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Problemas de tiroides</td><td align="left" width="10%">' + tiroides + '</td>';
            xml += '<td align="left" width="10%">Especifique: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resTiroides + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Se ha realizado pruebas de VIH</td><td align="left" width="10%">' + seHaHechoPruebas + '</td>';
            xml += '<td align="left" width="10%">Resultado: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + respuesta + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Se ha realizado pruebas de hepatitis</td><td align="left" width="10%">' + hepatitis + '</td>';
            xml += '<td align="left" width="10%">Resultado: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resHepatitis + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Medicamentos o suplementos alimenticios</td><td align="left" width="10%">' + suplementosAlimenticios + '</td>';
            xml += '<td align="left" width="10%">Especifique: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resSuplementosAlimenticios + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Estoy en terapia hormonal</td><td align="left" width="10%">' + terapiaHormonal + '</td>';
            xml += '<td align="left" width="10%">Especifique: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resTerapiaHormonal + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Tabaquismo</td><td align="left" width="10%">' + fuma + '</td>';
            xml += '<td align="left" width="10%"></td><td align="left" width="45%"></td></tr>';
            xml += '<tr><td align="left" widht="35%">Alcohol</td><td align="left" width="10%">' + ingiereConFrecuencia + '</td>';
            xml += '<td align="left" width="10%"></td><td align="left" width="45%"></td></tr>';
            xml += '<tr><td align="left" widht="35%">Drogas</td><td align="left" width="10%">' + drogas + '</td>';
            xml += '<td align="left" width="10%">Especifique: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resDrogas + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Problemas de cicatrización</td><td align="left" width="10%" colspan="3"><b>' + queTipoDeCicatrizacion + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">Problemas de coagulación</td><td align="left" width="10%">' + coagulacion + '</td>';
            xml += '<td align="left" width="10%">Especifique: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + resCoagulacion + '</b></td></tr>';
/*             xml += '<tr><td align="left" widht="35%">¿Sufre algún problema neurológico?</td><td align="left" width="10%">' + sufreDeAlgunProblema2 + '</td>';
            xml += '<td align="left" width="10%">Tratamiento: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + tratamiento2 + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">¿Toma actualmente algún medicamento?</td><td align="left" width="10%">' + tomaMedicamento + '</td>';
            xml += '<td align="left" width="10%">¿Cuá?: </td><td align="left" style="border-bottom: 1px solid;" width="45%"><b>' + cualMedicamento + '</b></td></tr>';
            xml += '<tr><td align="left" widht="35%">¿Ha presentado sangrado GIN. o nasal?</td><td align="left" width="10%">' + sangradoGinNasal + '</td>';
            xml += '<td align="left" width="10%"></td><td align="left" width="45%"></td></tr>'; */
            xml += '</table><br/>';


            xml += "<table style=\"width:100%;font-size:10px; font-family:'Aria', sans-serif\">";
            xml += '<tr><td align="left" colspan="4" style="border-top: 1px solid">Antecedentes no patológicos, tratamientos previos convencionales, alternativos o tradicionales: </td></tr>';
            xml += '<tr><td align="left" colspan="4" style="border-bottom: 1px solid"><b>' + antecedentesPatologicos + ' </b></td></tr>';
/*             xml += '<td align="left" style="border-bottom: 1px solid;" width="55%"><b>' + antPatPreviosConvencionales + '</b></td></tr>';
            xml += '<tr><td align="left" colspan="2">Antecedentes no patológicos, tratamientos previos alternativos: </td>';
            xml += '<td align="left" style="border-bottom: 1px solid;" width="55%"><b>' + antPatPreviosAlternativos + '</b></td></tr>';
            xml += '<tr><td align="left" colspan="2">Antecedentes no patológicos, tratamientos previos tradicionales: </td>';
            xml += '<td align="left" style="border-bottom: 1px solid;" width="55%"><b>' + antPatPreviosTradicionelas + '</b></td></tr>'; */
            xml += '</table>';
            xml += '<div style=\"page-break-after: always;\"></div>';
            xml += '<br/><br/><br/><br/><br/>';


            xml += '<p style="width:35%;background-color:#346094;color:#FFFFFF;font-family:Aria, sans-serif;align:center">FORMATO DE HISTORIA CLÍNICA</p>';
...
/*             xml += "<table style=\"width:100%;font-size:11px; font-family:'Aria', sans-serif\">";
            ...
            xml += "<table style=\"width:100%;font-size:10px; font-family:'Aria', sans-serif\">";
            xml += '<tr><td align="left" colspan="4" color="#FFFFFF" background-color="#346094"><b> Antecedentes Heredofamiliares</b></td></tr>';
            xml += '<tr><td align="left" width="25%">Diabetes: </td><td align="left" width="10%">' + diabetes1 + '</td>';
            xml += '<td align="left" width="20%">Especifique familiar: </td><td align="left" width="45%" style="border-bottom: 1px solid;"><b>' + especifiqueDiabetes1 + '</b></td></tr>';
            xml += '<tr><td align="left" width="25%">Hipertensión Arterial: </td><td align="left" width="10%">' + hipertensionArterial + '</td>';
            xml += '<td align="left" width="20%">Especifique familiar: </td><td align="left" width="45%" style="border-bottom: 1px solid;"><b>' + especifiqueHipertensionArterial + '</b></td></tr>';
            xml += '<tr><td align="left" width="25%">Cáncer: </td><td align="left" width="10%">' + cancer2 + '</td>';
            xml += '<td align="left" width="20%">Especifique familiar: </td><td align="left" width="45%" style="border-bottom: 1px solid;"><b>' + especifiqueCancer2 + '</b></td></tr>';
            xml += '</table><br/>';

            xml += "<table style=\"width:100%;font-size:10px; font-family:'Aria', sans-serif\">";
            xml += '<tr><td align="left" colspan="4" color="#FFFFFF" background-color="#346094"><b> Antecedentes Ginecoobstétricos (si aplica)</b></td></tr>';
            xml += '<tr><td align="left" width="25%">Menarca: </td><td align="left" width="70%"><b>' + menarca + '</b></td></tr>';
            xml += '<tr><td align="left" width="25%">Fecha de última mensatruación: </td><td align="left" width="70%"><b>' + menstruacion + '</b></td></tr>';
            xml += '<tr><td align="left" width="20%">Embarazos:</td></tr>';
            xml += '</table>';
            xml += "<table style=\"width:100%;font-size:10px; font-family:'Aria', sans-serif\">";
            xml += '<tr>';
            xml += '<td align="center" width="5%">G </td><td align="center" width="8%" style="border: 1px solid;"><b>' + g + '</b></td>';
            xml += '<td align="center" width="5%">P </td><td align="center" width="8%" style="border: 1px solid;"><b>' + p + '</b></td>';
            xml += '<td align="center" width="5%">C </td><td align="center" width="8%" style="border: 1px solid;"><b>' + c + '</b></td>';
            xml += '<td align="center" width="5%">A </td><td align="center" width="8%" style="border: 1px solid;"><b>' + a + '</b></td>';
            xml += '</tr>';
            xml += '</table><br/>';

            xml += "<table style=\"width:100%;font-size:10px; font-family:'Aria', sans-serif\">";
            xml += '<tr><td align="left" colspan="5" color="#FFFFFF" background-color="#346094"><b> Exploración física</b></td></tr>';
            xml += '<tr><td align="left" width="17%">Temperatura: </td><td align="left" width="30%" style="border-bottom: 1px solid;"><b>' + temperatura + '</b></td><td width="3%"></td>';
            xml += '<td align="left" width="17%">Presión arterial: </td><td align="left" width="30%" style="border-bottom: 1px solid;"><b>' + presionArterial + '</b></td></tr>';
            xml += '<tr><td align="left" width="17%">Frecuencia cardíaca: </td><td align="left" width="30%" style="border-bottom: 1px solid;"><b>' + frecuenciaCardiaca + '</b></td><td width="3%"></td>';
            xml += '<td align="left" width="17%">Frecuencia respiratoria: </td><td align="left" width="30%" style="border-bottom: 1px solid;"><b>' + frecuenciaRespiratoria + '</b></td></tr>';
            xml += '<tr><td align="left" width="17%">Peso: </td><td align="left" width="30%" style="border-bottom: 1px solid;"><b>' + peso + '</b></td><td width="3%"></td>';
            xml += '<td align="left" width="17%">Talla: </td><td align="left" width="30%" style="border-bottom: 1px solid;"><b>' + talla + '</b></td></tr>';
            xml += '<tr><td align="left" width="17%">Datos de la especialidad: </td><td align="left" width="30%" style="border-bottom: 1px solid;"><b>' + especialidad + '</b></td><td width="3%"></td>';
            xml += '<td align="left" width="17%">IDC: </td><td align="left" width="30%" style="border-bottom: 1px solid;"><b>' + idc + '</b></td></tr>';
            xml += '</table><br/>';

            xml += "<table style=\"width:100%;font-size:10px; font-family:'Aria', sans-serif\">";
            xml += '<tr><td align="left" width="30%">Aspecto externo del paciente (condición): </td><td align="left" style="border-bottom: 1px solid;"><b>' + aspectoFisico + '</b></td></tr>';
            xml += '<tr><td align="left" width="30%">Sexo del paciente (aparente): </td><td align="left" style="border-bottom: 1px solid;"><b>' + sexoAparente + '</b></td></tr>';
            xml += '<tr><td align="left" width="30%">Edad (aparente): </td><td align="left" style="border-bottom: 1px solid;"><b>' + edadAparente + '</b></td></tr>';
            xml += '<tr><td align="left" width="30%">Constitución del paciente: </td><td align="left" style="border-bottom: 1px solid;"><b>' + constitucionPaciente + '</b></td></tr>';
            xml += '</table><br/>';

            xml += "<table style=\"width:100%;font-size:10px; font-family:'Aria', sans-serif\">";
            xml += '<tr><td align="left" colspan="4" color="#FFFFFF" background-color="#346094"><b> Datos clínicos reelevantes</b></td></tr>';
