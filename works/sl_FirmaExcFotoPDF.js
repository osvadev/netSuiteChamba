...
define(['N/ui/serverWidget', 'N/record', 'N/xml', 'N/file']),
  ...
  function (widget, record, xml, file) {
    ...
    function onRequest(context) {
      var recodrCaseId = context.request.parameters.recodrCaseId;
      var compaId = context.request.parameters.compaId;

      var inRecord = record.load({ type: 'supportcase', id: recodrCaseId, isDynamic: true});
      var cliente = inRecord.getValue({})
    }
  }
...
define(['N/record', 'N/log', 'N/render', 'N/xml'],
  ...
  function (record, log, render, xmlMod) {
    ...
    function onRequest(context) {
      ...
      var avisoPrivacidadbase64 = caso.getValue({ fieldId: 'custevent510' });
