...
define(['N/record','N/log','N/render','N/xml'],
    ...
    function(record,log,render,xmlMod) {
      ...
      function onRequest(context) {
        ...
        var avisoMexico = '<p style="width:35%;color:#000000;font-family:Aria, sans-serif;align:center"><b>CONSENTIMIENTO INFORMADO</b></p>';
        avisoMexico += '<p style="font-size: medium;color:#000000;font-family:Aria, sans-serif;"><b>FECHA</b> <b> '+ fechaC +' </b></p>';
        ...
        avisoMexico += '<p style="font-size: medium;color:#000000;font-family:Aria, sans-serif;"><b>RIESGOS</b></p>';
        avisoMexico += '<p style="font-family:Aria, sans-serif; font-size:12px;">Como en cualquier procedimiento médico, existen riesgos asociados. La mayoría de los pacientes no presentan complicaciones, sin embargo, usted debe tener conocimiento de las principales situaciones que pudieran presentarse:</p>';
        ...
        avisoMexico += '<p style="font-family:Aria, sans-serif; font-size:12px;">Asimetría. La cara humana es normalmente asimétrica. Puede haber variación entre un lado y otro tras un procedimiento de trasplante capilar.</p>';
        avisoMexico += '<p style="font-family:Aria, sans-serif; font-size:12px;">Anestesia. La anestesia realizada durante el procedimiento es local inyectable, sin embargo implica ciertos riesgos como reacción alérgica, edema y pérdida transitoria de la sensibilidad local.</p>';
        ...
        avisoMexico += '<p style="font-family:Aria, sans-serif; font-size:12px;">Retraso en la cicatrización. Los pacientes fumadores y diabéticos tienen un mayor riesgo de complicaciones en cuanto a la cicatrización. El uso de algunos medicamentos, también puede retrasar este proceso.</p>';
        ...
        avisoMexico += '<p style="font-size: medium;color:#000000;font-family:Aria, sans-serif;"><b>BENEFICIOS</b></p>';
        avisoMexico += '<p style="font-size: medium;">Recuperación de densidad capilar en la zona a implantar (Dependiendo de la cantidad de folículos obtenida, características de la piel del paciente y cuidados del paciente posteriores al procedimiento).</p>';
        avisoMexico += ' <p></p><p></p><p></p><p></p><p></p><p></p><p></p><p></p>';
        avisoMexico += '<p style="font-size: medium;color:#000000;font-family:Aria, sans-serif;"><b>CONSENTIMIENTO PARA EL PROCEDIMIENTO</b></p>';
        avisoMexico += '<p style="font-size: medium;">1.	Por el presente documento, autorizo al equipo médico y los auxiliares médicos de Kaloni Holding Group, S.C., a realizar el procedimiento de injerto de cabello.</p>';
        avisoMexico += '<p style="font-size: medium;">2.	He sido también informado(a) que mis datos personales serán protegidos e incluidos en un expediente clínico, en conformidad con la legislación Mexicana aplicable.</p>';
        avisoMexico += '<p style="font-size: medium;">3.	Autorizo la toma de fotografías de la zona con fines clínicos.</p>';
        avisoMexico += '<p style="font-size: medium;">4.	Manifiesto que se me informó detalladamente las precauciones relativas a mi procedimiento y me obligo a cumplir con todas las indicaciones que se me den respecto a los cuidados que debo tener post-procedimiento, así como a acudir a las citas que me sean asignadas ya que se me ha hecho hincapié en las atenciones necesarias para lograr el objetivo esperado. Sé y estoy de acuerdo en que gran parte del éxito recae en los cuidados de los mismos.</p>';
        avisoMexico += '<p style="font-size: medium;">5.	Declaro que el médico me ha informado y ofrecido alternativas al procedimiento al que he decidido someterme.</p>';
        avisoMexico += '<p style="font-size: medium;">6.	Se me ha explicado que durante el procedimiento pueden presentarse imprevistos que varíen el procedimiento original, por consiguiente ante cualquier complicación a efecto adverso durante dicho procedimiento, especialmente ante una urgencia médica autorizo y solicito al médico tratante y a sus colaboradores, que realicen los procedimientos médicos que consideren necesarios, en ejercicio de su juicio y experiencia profesional, para la protección de mi salud.</p>';
        avisoMexico += '<p style="font-size: medium;">Comprendido el alcance de los riesgos y beneficios, firmo este consentimiento por mi libre voluntad sin haber estado sujeto(a) a ningún tipo de presión o coacción para hacerlo, por lo anterior es mi decisión autorizar al médico a someterme al procedimiento.</p>';
        avisoMexico += '<p></p><p></p><p></p><p></p>';
        avisoMexico += '<p style="align:center"><img src="'+avisoPrivacidadbase64+'" width="100" height="100" /></p>';
        avisoMexico += '<p style="align:center;font-family:Aria, sans-serif; font-size:13px;"><b>____________________________<br/>FIRMA DEL PACIENTE</b></p>';
